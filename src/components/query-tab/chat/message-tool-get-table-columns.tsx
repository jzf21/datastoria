            ...
            <Table className="text-[11px]">
              <TableHeader className="bg-muted/50">
                <TableRow className="hover:bg-transparent border-b">
                  <TableHead className="h-7 px-2 font-bold text-muted-foreground border-r last:border-r-0">database</TableHead>
                  <TableHead className="h-7 px-2 font-bold text-muted-foreground border-r last:border-r-0">table</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {inputTables.map((t: TableInput, idx: number) => (
                  <TableRow key={idx} className="hover:bg-muted/30 border-b last:border-0">
                    <TableCell className="py-1 px-2 whitespace-nowrap border-r last:border-r-0">{t.database}</TableCell>
                    <TableCell className="py-1 px-2 whitespace-nowrap border-r last:border-r-0">{t.table}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
                ...
                <div key={tableIdx} className="mb-2 last:mb-0">
                  ...
                  <Table className="text-[11px]">
                    <TableHeader className="bg-muted/30">
                      <TableRow className="hover:bg-transparent border-b">
                        <TableHead className="h-7 px-2 font-bold text-muted-foreground border-r last:border-r-0">name</TableHead>
                        <TableHead className="h-7 px-2 font-bold text-muted-foreground border-r last:border-r-0">type</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {tableGroup.columns?.map((col, colIdx: number) => (
                        <TableRow key={colIdx} className="hover:bg-muted/30 border-b last:border-0">
                          ...
                          <TableCell className="py-1 px-2 whitespace-nowrap border-r last:border-r-0">{col.type}</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
